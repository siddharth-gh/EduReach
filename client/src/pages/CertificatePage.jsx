...
const CertificatePage = () => {
  ...
  if (!certificate) return <AppShell><div className="max-w-4xl mx-auto px-4 py-20 animate-pulse"><div className="h-[600px] bg-surface-soft rounded-[64px]"></div></div></AppShell>;
  ...
  return (
    <AppShell>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
        ...
        <div className="relative bg-surface border-[16px] border-border rounded-[64px] p-10 lg:p-24 shadow-2xl shadow-blue-600/10 text-center overflow-hidden">
           {/* Decorative elements */}
           ...
           <div className="relative z-10 flex flex-col items-center">
              ...
              <h1 className="text-5xl lg:text-7xl font-black text-primary mb-10 tracking-tight">
                 {certificate.student.name}
              </h1>

              <div className="w-24 h-px bg-surface-muted mb-10" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-2xl text-left border-t border-gray-50 dark:border-gray-800 pt-16">
                 <div>
                    ...
                    <p className="text-lg font-bold text-primary">{certificate.course.teacherName}</p>
                 </div>
                 <div className="text-right">
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Date Awarded</p>
                    <p className="text-lg font-bold text-primary">{new Date(certificate.completedAt).toLocaleDateString(undefined, { month: 'long', day: 'numeric', year: 'numeric' })}</p>
                 </div>
              </div>

              <div className="mt-24 pt-10 border-t border-gray-50 dark:border-gray-800 w-full flex justify-center">
                 <div className="flex flex-col items-center opacity-30">
                    <div className="w-16 h-16 border-4 border-gray-400 rounded-full flex items-center justify-center font-black text-gray-400 text-xl">RS</div>
                    <p className="text-[8px] font-black uppercase tracking-widest mt-2">RemoteSmart Official</p>
                 </div>
              </div>
           </div>
        </div>
        ...
        <div className="mt-12 flex justify-center gap-4 no-print">
           ...
           <button onClick={() => navigate('/dashboard')} className="px-10 py-4 bg-surface text-primary font-bold rounded-2xl border border-border hover:bg-gray-50 transition-all">
              Return to Portal
           </button>
        </div>
      </div>
